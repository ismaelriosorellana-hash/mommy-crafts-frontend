...
required = [
    ROOT / "index.html",
    ROOT / "css" / "mc-commerce-tools-v3311.css",
...
for path in ROOT.glob("*.html"):
    ...
    text = re.sub(
        ...
        'css/mc-commerce-tools-v3311.css?v=3.31.3',
        text
    )
    text = re.sub(
        r'js/site-settings\.js\?v=[^"\']+',
        'js/site-settings.js?v=3.31.3',
        text
    )
    if text != original:
...
print("Parche Frontend V3.31.3 aplicado correctamente.")
