...
if (!config.includes('APP_VERSION: "3.60.1"')) {
    errors.push("js/config.js debe informar APP_VERSION 3.60.1.");
}
...
console.log("✅ Monitoreo de producción frontend v3.60.1 verificado.");
