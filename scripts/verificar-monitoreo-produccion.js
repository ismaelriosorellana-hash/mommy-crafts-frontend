...
if (!config.includes('APP_VERSION: "3.61.1"')) {
    errors.push("js/config.js debe informar APP_VERSION 3.61.1.");
}
...
console.log("✅ Monitoreo de producción frontend v3.61.1 verificado.");
