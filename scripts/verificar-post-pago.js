...
check("pago.html carga CSS post-pago v3.43.1", pago.includes("css/post-purchase-v3430.css?v=3.43.1"));
...
check("versión de app actualizada", config.includes('APP_VERSION: "3.43.1"'));
