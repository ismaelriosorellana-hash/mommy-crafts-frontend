...
check("pago.html carga CSS post-pago v3.47.0", pago.includes("css/post-purchase-v3430.css?v=3.52.0"));
...
check("versión de app actualizada", config.includes('APP_VERSION: "3.52.0"'));
