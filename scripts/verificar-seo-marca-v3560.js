...
const checks = [
  ["version config", config.includes('APP_VERSION: "3.56.0"')],
...
if (failed.length) {
  console.error("❌ SEO de marca v3.56.0 con errores:");
  failed.forEach(([name]) => console.error(`- ${name}`));
  process.exit(1);
}

console.log("✅ SEO de marca y limpieza Netlify frontend v3.56.0 verificado");
