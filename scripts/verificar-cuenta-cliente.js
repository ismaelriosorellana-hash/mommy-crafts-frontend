...
ok(cuenta.includes("css/account-dashboard-v3470.css?v=3.51.0"), "cuenta carga estilos de dashboard cliente v3.47.0");
ok(cuenta.includes("js/account-dashboard-v3470.js?v=3.51.0"), "cuenta carga lógica de dashboard cliente v3.47.0");
