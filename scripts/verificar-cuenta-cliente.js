...
ok(cuenta.includes("css/account-dashboard-v3470.css?v=3.61.1"), "cuenta carga estilos de dashboard cliente v3.47.0");
ok(cuenta.includes("js/account-dashboard-v3470.js?v=3.61.1"), "cuenta carga lógica de dashboard cliente v3.47.0");
