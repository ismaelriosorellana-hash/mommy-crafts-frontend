...
ok(config.includes('APP_VERSION: "3.53.0"'), "CONFIG informa versión 3.53.0");
ok(config.includes('SITE_URL: "https://mommycrafts.onrender.com"'), "CONFIG define URL pública oficial");
ok(exists("js/seo-v3490.js"), "helper SEO v3.53.0 existe");
...
for (const page of [...indexedPages, ...noindexPages]) {
    ...
    ok(html.includes("js/seo-v3490.js?v=3.53.0"), `${page} carga helper SEO`);
...
console.log("\n✅ SEO, rendimiento y confianza v3.53.0 verificados.");
