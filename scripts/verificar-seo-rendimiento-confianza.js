...
ok(config.includes('APP_VERSION: "3.62.2"'), "CONFIG informa versión 3.62.2");
ok(config.includes('SITE_URL: "https://mommycrafts.cl"'), "CONFIG define URL pública oficial");
ok(exists("js/seo-v3490.js"), "helper SEO v3.62.2 existe");
...
for (const page of [...indexedPages, ...noindexPages]) {
    ...
    ok(html.includes("js/seo-v3490.js?v=3.62.2"), `${page} carga helper SEO`);
...
console.log("\n✅ SEO, rendimiento y confianza v3.62.2 verificados.");
