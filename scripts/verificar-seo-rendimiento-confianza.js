...
ok(config.includes('APP_VERSION: "3.50.0"'), "CONFIG informa versión 3.50.0");
ok(config.includes('SITE_URL: "https://mommycrafts.onrender.com"'), "CONFIG define URL pública oficial");
ok(exists("js/seo-v3490.js"), "helper SEO v3.50.0 existe");
...
for (const page of [...indexedPages, ...noindexPages]) {
    ...
    ok(html.includes("js/seo-v3490.js?v=3.50.0"), `${page} carga helper SEO`);
...
ok(robots.includes("Sitemap: https://mommycrafts.onrender.com/sitemap.xml"), "robots.txt declara sitemap público");
...
ok(sitemap.includes("https://mommycrafts.onrender.com/"), "sitemap incluye home");
ok(sitemap.includes("https://mommycrafts.onrender.com/catalogo.html"), "sitemap incluye catálogo");
ok(sitemap.includes("https://mommycrafts.onrender.com/despachos-retiros.html"), "sitemap incluye despachos/retiros");
...
console.log("\n✅ SEO, rendimiento y confianza v3.50.0 verificados.");
