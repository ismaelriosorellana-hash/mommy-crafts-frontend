...
const checks = [
    ...
    ["CSS profesional existe", css.includes("Personalización profesional v3.43.3")],
...
for (const page of pages) {
    ...
    checks.push([
        ...
        html.includes('css/customization-professional-v3390.css?v=3.43.3')
    ]);
    checks.push([
        `${page} carga JS profesional`,
        html.includes('js/customization-professional-v3390.js?v=3.43.3')
    ]);
}
...
console.log(`\n✅ Personalización profesional v3.43.3 verificada (${checks.length} controles).`);
