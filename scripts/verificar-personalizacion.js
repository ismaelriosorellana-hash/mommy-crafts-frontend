...
const checks = [
    ...
    ["CSS profesional existe", css.includes("Personalización profesional v3.39.0")],
...
for (const page of pages) {
    ...
    checks.push([
        ...
        html.includes('css/customization-professional-v3390.css?v=3.39.0')
    ]);
    checks.push([
        `${page} carga JS profesional`,
        html.includes('js/customization-professional-v3390.js?v=3.39.0')
    ]);
}
...
console.log(`\n✅ Personalización profesional v3.39.0 verificada (${checks.length} controles).`);
