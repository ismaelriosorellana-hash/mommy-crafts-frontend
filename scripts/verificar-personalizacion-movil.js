...
for (const page of pages) {
  ...
  mustInclude(html, 'css/customization-mobile-safe-v3434.css?v=3.44.0', `${page} carga CSS móvil seguro v3.44.0`);
  mustInclude(html, 'css/customization-mobile-preview-v3435.css?v=3.44.0', `${page} carga corrección de vista previa móvil v3.44.0`);
...
mustInclude(css, 'Personalización móvil segura v3.44.0', 'CSS móvil seguro corresponde a v3.44.0');

mustInclude(previewCss, 'Vista previa móvil completa v3.44.0', 'CSS de vista previa móvil corresponde a v3.44.0');
