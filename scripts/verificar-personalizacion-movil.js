...
for (const page of pages) {
  ...
  mustInclude(html, 'css/customization-mobile-safe-v3434.css?v=3.60.0', `${page} carga CSS móvil seguro v3.47.0`);
  mustInclude(html, 'css/customization-mobile-preview-v3435.css?v=3.60.0', `${page} carga corrección de vista previa móvil v3.47.0`);
