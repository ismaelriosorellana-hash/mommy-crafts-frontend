...
for (const page of pages) {
  ...
  mustInclude(html, 'css/customization-mobile-safe-v3434.css?v=3.43.4', `${page} carga CSS móvil seguro v3.43.4`);
...
mustInclude(css, 'Personalización móvil segura v3.43.4', 'CSS móvil seguro corresponde a v3.43.4');
