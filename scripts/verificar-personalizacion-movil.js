...
for (const page of pages) {
  ...
  mustInclude(html, 'css/customization-mobile-safe-v3434.css?v=3.46.2', `${page} carga CSS móvil seguro v3.46.2`);
  mustInclude(html, 'css/customization-mobile-preview-v3435.css?v=3.46.2', `${page} carga corrección de vista previa móvil v3.46.2`);
...
mustInclude(css, 'Personalización móvil segura v3.46.2', 'CSS móvil seguro corresponde a v3.46.2');

mustInclude(previewCss, 'Vista previa móvil completa v3.46.2', 'CSS de vista previa móvil corresponde a v3.46.2');
