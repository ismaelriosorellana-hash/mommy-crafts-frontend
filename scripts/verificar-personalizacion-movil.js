...
for (const page of pages) {
  ...
  mustInclude(html, 'css/customization-mobile-safe-v3434.css?v=3.43.5', `${page} carga CSS móvil seguro v3.43.5`);
  mustInclude(html, 'css/customization-mobile-preview-v3435.css?v=3.43.5', `${page} carga corrección de vista previa móvil v3.43.5`);
...
mustInclude(css, 'Personalización móvil segura v3.43.5', 'CSS móvil seguro corresponde a v3.43.5');

mustInclude(previewCss, 'Vista previa móvil completa v3.43.5', 'CSS de vista previa móvil corresponde a v3.43.5');
