...
assert(html.includes("orders-admin.js?v=3.48.0"), "Panel de pedidos carga módulo base de pedidos v3.47.0.");
assert(html.includes("orders-admin-pro-v3450.js?v=3.48.0"), "Panel de pedidos mantiene mejoras visuales operativas.");
