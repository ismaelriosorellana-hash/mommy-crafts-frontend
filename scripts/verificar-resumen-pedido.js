...
const checks = [
    ...
    ["CSS checkout preview fiel", checkoutCss.includes("V3.43.0 · Resumen de pedido") && checkoutCss.includes("object-fit: contain")],
    ["CSS detalle pedido preview fiel", accountCss.includes("V3.43.0 · Detalle de pedido") && accountCss.includes("customer-order-item-image-link")]
];
...
console.log(`\n✅ Resumen de pedido personalizado v3.43.0 verificado (${checks.length} controles).`);
