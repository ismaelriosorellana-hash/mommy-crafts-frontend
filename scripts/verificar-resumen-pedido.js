...
const checks = [
    ...
    ["Personalizador captura preview visible", customization.includes("capturePreviewSnapshot") && customization.includes("visible-preview-v3400")],
    ...
    ["CSS checkout preview fiel", checkoutCss.includes("V3.40.0 · Resumen de pedido") && checkoutCss.includes("object-fit: contain")],
    ["CSS detalle pedido preview fiel", accountCss.includes("V3.40.0 · Detalle de pedido") && accountCss.includes("customer-order-item-image-link")]
];
...
console.log(`\n✅ Resumen de pedido personalizado v3.40.0 verificado (${checks.length} controles).`);
