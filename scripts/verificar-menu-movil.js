...
const checks = [
    ["CONFIG versión 3.57.0", config.includes('APP_VERSION: "3.57.0"')],
    ["CSS de menú móvil cargado en inicio", index.includes('css/mobile-menu-v3380.css?v=3.57.0')],
    ["CSS de menú móvil cargado en producto", product.includes('css/mobile-menu-v3380.css?v=3.57.0')],
    ["JS de menú móvil cargado en inicio", index.includes('js/mobile-menu-v3380.js?v=3.57.0')],
    ["JS de menú móvil cargado en producto", product.includes('js/mobile-menu-v3380.js?v=3.57.0')],
