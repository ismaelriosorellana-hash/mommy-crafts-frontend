...
const checks = [
    ["CONFIG versión 3.54.1", config.includes('APP_VERSION: "3.54.1"')],
    ["CSS de menú móvil cargado en inicio", index.includes('css/mobile-menu-v3380.css?v=3.54.1')],
    ["CSS de menú móvil cargado en producto", product.includes('css/mobile-menu-v3380.css?v=3.54.1')],
    ["JS de menú móvil cargado en inicio", index.includes('js/mobile-menu-v3380.js?v=3.54.1')],
    ["JS de menú móvil cargado en producto", product.includes('js/mobile-menu-v3380.js?v=3.54.1')],
