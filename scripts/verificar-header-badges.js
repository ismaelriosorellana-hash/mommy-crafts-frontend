...
const checks = [
    ...
    ["Navbar móvil uniforme v3.40.1", (mobileCss.includes("--mc-mobile-action-size: 39px") || mobileMenuCss.includes("--mc-mobile-action-size: 39px")) && mobileCss.includes("margin-top: -25px !important")],
    ...
    ["Menú móvil profesional v3.40.1", mobileMenuCss.includes("mc-mobile-menu-panel") && mobileMenuJs.includes("data-mobile-menu-action") && mobileMenuJs.includes("category-view")],
];
...
console.log(`\n✅ Header, badges y menú móvil v3.40.1 verificados (${checks.length} controles).`);
