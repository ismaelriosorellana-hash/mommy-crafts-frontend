...
check("seguimiento carga CSS v3.47.0", page.includes("css/order-tracking-v3440.css?v=3.59.0"));
check("seguimiento carga JS v3.47.0", page.includes("js/order-tracking-v3440.js?v=3.59.0"));
check("versión de app actualizada a 3.59.0", config.includes('APP_VERSION: "3.59.0"'));
