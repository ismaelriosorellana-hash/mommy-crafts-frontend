...
check(html.includes("js/orders-admin.js?v=3.60.1"), "Pedidos carga JS principal v3.47.0.");
check(html.includes("js/orders-admin-pro-v3450.js?v=3.60.1"), "Pedidos carga capa visual estable v3.47.0.");
