...
check(html.includes("js/orders-admin.js?v=3.46.2"), "Pedidos carga JS principal v3.46.2.");
check(html.includes("js/orders-admin-pro-v3450.js?v=3.46.2"), "Pedidos carga capa visual estable v3.46.2.");
