...
const checks = [
  ['CSS específico v3.43.3 cargado', html.includes('css/product-detail-v3340.css?v=3.43.3')],
  ...
  ['Ficha usa CSS específico v3.43.3', html.includes('css/product-detail-v3340.css?v=3.43.3')],
...
console.log(`\n✅ Ficha de producto v3.43.3 verificada (${checks.length} controles).`);
