...
const checks = [
  ['CSS específico v3.36.8 cargado', html.includes('css/product-detail-v3340.css?v=3.36.8')],
  ...
  ['Navbar móvil de ficha tiene acciones en columna derecha', mainCss.includes('V3.36.8 · Corrección puntual') && /body\[data-page=\"product\"\] \.site-header \.navbar-actions[\s\S]*grid-column:\s*3 !important/.test(mainCss)],
  ['Ficha usa CSS específico v3.36.8', html.includes('css/product-detail-v3340.css?v=3.36.8')],
  ['Imagen móvil compacta bajo navbar', productCss.includes('V3.36.8 · Ajuste fino móvil') && productCss.includes('clamp(28rem, 82vw, 36rem)')],
];
...
console.log(`\n✅ Ficha de producto v3.36.8 verificada (${checks.length} controles).`);
