...
const checks = [
  ['CSS específico v3.46.0 cargado', html.includes('css/product-detail-v3340.css?v=3.46.0')],
  ...
  ['Ficha usa CSS específico v3.46.0', html.includes('css/product-detail-v3340.css?v=3.46.0')],
...
console.log(`\n✅ Ficha de producto v3.46.0 verificada (${checks.length} controles).`);
