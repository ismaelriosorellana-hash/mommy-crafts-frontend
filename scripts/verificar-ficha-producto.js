...
const checks = [
  ['CSS específico v3.39.0 cargado', html.includes('css/product-detail-v3340.css?v=3.39.0')],
  ...
  ['Ficha usa CSS específico v3.39.0', html.includes('css/product-detail-v3340.css?v=3.39.0')],
...
console.log(`\n✅ Ficha de producto v3.39.0 verificada (${checks.length} controles).`);
