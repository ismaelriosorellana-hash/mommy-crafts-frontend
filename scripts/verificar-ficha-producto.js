...
const checks = [
  ['CSS específico v3.43.4 cargado', html.includes('css/product-detail-v3340.css?v=3.43.4')],
  ...
  ['Ficha usa CSS específico v3.43.4', html.includes('css/product-detail-v3340.css?v=3.43.4')],
...
console.log(`\n✅ Ficha de producto v3.43.4 verificada (${checks.length} controles).`);
