...
const checks = [
  ['CSS específico v3.43.5 cargado', html.includes('css/product-detail-v3340.css?v=3.43.5')],
  ...
  ['Ficha usa CSS específico v3.43.5', html.includes('css/product-detail-v3340.css?v=3.43.5')],
...
console.log(`\n✅ Ficha de producto v3.43.5 verificada (${checks.length} controles).`);
