...
const checks = [
  ['CSS específico v3.43.1 cargado', html.includes('css/product-detail-v3340.css?v=3.43.1')],
  ...
  ['Ficha usa CSS específico v3.43.1', html.includes('css/product-detail-v3340.css?v=3.43.1')],
...
console.log(`\n✅ Ficha de producto v3.43.1 verificada (${checks.length} controles).`);
