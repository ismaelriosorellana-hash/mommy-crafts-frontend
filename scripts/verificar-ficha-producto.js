...
const checks = [
  ['CSS específico v3.41.0 cargado', html.includes('css/product-detail-v3340.css?v=3.41.0')],
  ...
  ['Ficha usa CSS específico v3.41.0', html.includes('css/product-detail-v3340.css?v=3.41.0')],
...
console.log(`\n✅ Ficha de producto v3.41.0 verificada (${checks.length} controles).`);
