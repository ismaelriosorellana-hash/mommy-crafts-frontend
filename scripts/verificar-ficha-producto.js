...
const checks = [
  ['CSS específico v3.43.2 cargado', html.includes('css/product-detail-v3340.css?v=3.43.2')],
  ...
  ['Ficha usa CSS específico v3.43.2', html.includes('css/product-detail-v3340.css?v=3.43.2')],
...
console.log(`\n✅ Ficha de producto v3.43.2 verificada (${checks.length} controles).`);
