...
const checks = [
  ['CSS específico v3.47.0 cargado', html.includes('css/product-detail-v3340.css?v=3.49.0')],
  ...
  ['Ficha usa CSS específico v3.47.0', html.includes('css/product-detail-v3340.css?v=3.49.0')],
