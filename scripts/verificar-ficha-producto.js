...
const checks = [
  ['CSS específico v3.40.0 cargado', html.includes('css/product-detail-v3340.css?v=3.40.0')],
  ...
  ['Ficha usa CSS específico v3.40.0', html.includes('css/product-detail-v3340.css?v=3.40.0')],
...
console.log(`\n✅ Ficha de producto v3.40.0 verificada (${checks.length} controles).`);
