...
const checks = [
    ...
    ["Páginas públicas cargan categories.js", htmlFiles.every((name) => {
        ...
        return !html.includes("js/products.js") || html.includes("js/categories.js?v=3.43.5");
    })],
    ...
    ["Carruseles sin fondo global", homeCss.includes("V3.43.5") && homeCss.includes("background: transparent !important")],
...
console.log(`\n✅ Categorías administrables v3.43.5 verificadas (${checks.length} controles).`);
