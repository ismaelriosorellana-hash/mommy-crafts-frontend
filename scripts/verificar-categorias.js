...
const checks = [
    ...
    ["Páginas públicas cargan categories.js", htmlFiles.every((name) => {
        ...
        return !html.includes("js/products.js") || html.includes("js/categories.js?v=3.36.8");
    })],
    ...
    ["Carruseles sin fondo global", homeCss.includes("V3.36.8") && homeCss.includes("background: transparent !important")],
...
console.log(`\n✅ Categorías administrables v3.36.8 verificadas (${checks.length} controles).`);
