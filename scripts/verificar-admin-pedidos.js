...
mustInclude(page, "css/admin-orders-pro-v3450.css?v=3.56.0", "pedidos.html carga la capa visual profesional v3.47.0");
mustInclude(page, "js/orders-admin-pro-v3450.js?v=3.56.0", "pedidos.html carga el complemento operativo v3.47.0");
