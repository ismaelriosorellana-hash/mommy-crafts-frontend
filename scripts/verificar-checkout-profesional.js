...
const checks = [
  ...
  ['finalizar-compra.html', 'css/checkout-professional-v3420.css?v=3.44.0'],
  ['finalizar-compra.html', 'js/checkout-professional-v3420.js?v=3.44.0']
];
const failures = [];
...
console.log('✅ Checkout profesional v3.44.0 verificado.');
