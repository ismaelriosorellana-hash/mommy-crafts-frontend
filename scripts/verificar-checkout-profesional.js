...
const checks = [
  ...
  ['finalizar-compra.html', 'css/checkout-professional-v3420.css?v=3.43.1'],
  ['finalizar-compra.html', 'js/checkout-professional-v3420.js?v=3.43.1']
];
const failures = [];
...
console.log('✅ Checkout profesional v3.43.1 verificado.');
