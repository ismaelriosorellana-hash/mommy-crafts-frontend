...
assert(html.includes("orders-admin.js?v=3.61.1"), "Pedidos debe cargar JS con versión 3.61.1.");
assert(html.includes("admin-orders-pro-v3450.css?v=3.61.1"), "Pedidos debe cargar CSS con versión 3.61.1.");
...
console.log("✅ Comunicación de pedidos v3.61.1 verificada.");
