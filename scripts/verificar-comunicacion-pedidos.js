...
assert(html.includes("orders-admin.js?v=3.62.2"), "Pedidos debe cargar JS con versión 3.62.2.");
assert(html.includes("admin-orders-pro-v3450.css?v=3.62.2"), "Pedidos debe cargar CSS con versión 3.62.2.");
...
console.log("✅ Comunicación de pedidos v3.62.2 verificada.");
