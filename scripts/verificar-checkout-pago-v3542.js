...
check(config.includes('APP_VERSION: "3.59.0"'), 'CONFIG.APP_VERSION debe ser 3.59.0.');
...
if (errors.length) {
  console.error('❌ Verificación checkout pago v3.59.0 con errores:');
  errors.forEach((error) => console.error(`- ${error}`));
  process.exit(1);
}

console.log('✅ Checkout pago frontend v3.59.0 verificado.');
