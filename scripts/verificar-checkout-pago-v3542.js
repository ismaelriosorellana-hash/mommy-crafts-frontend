...
check(config.includes('APP_VERSION: "3.58.0"'), 'CONFIG.APP_VERSION debe ser 3.58.0.');
...
if (errors.length) {
  console.error('❌ Verificación checkout pago v3.58.0 con errores:');
  errors.forEach((error) => console.error(`- ${error}`));
  process.exit(1);
}

console.log('✅ Checkout pago frontend v3.58.0 verificado.');
