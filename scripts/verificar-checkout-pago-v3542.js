...
check(config.includes('APP_VERSION: "3.60.1"'), 'CONFIG.APP_VERSION debe ser 3.60.1.');
...
if (errors.length) {
  console.error('❌ Verificación checkout pago v3.60.1 con errores:');
  errors.forEach((error) => console.error(`- ${error}`));
  process.exit(1);
}

console.log('✅ Checkout pago frontend v3.60.1 verificado.');
