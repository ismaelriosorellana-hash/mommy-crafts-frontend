...
assert(index.includes('css/commercial-v3610.css?v=3.61.1'), 'index debe cargar commercial-v3610.css');
assert(product.includes('css/commercial-v3610.css?v=3.61.1'), 'producto debe cargar commercial-v3610.css');
...
assert(index.includes('index.html#como-funciona'), 'menú debe incluir acceso a Cómo funciona');
...
console.log('✅ Mejora comercial frontend v3.61.1 verificada');
