...
assert(index.includes('css/commercial-v3610.css?v=3.62.1'), 'index debe cargar commercial-v3610.css');
assert(product.includes('css/commercial-v3610.css?v=3.62.1'), 'producto debe cargar commercial-v3610.css');
...
console.log('✅ Mejora comercial frontend v3.62.1 verificada');
